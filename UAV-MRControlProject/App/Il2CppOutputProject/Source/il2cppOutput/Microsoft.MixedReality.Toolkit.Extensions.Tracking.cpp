...
IL_002a:
		{
			...
			LostTrackingServiceProfile_tB5E9DC2D6BDBB0A0F4E8EF30D8C59FB4D6B84CFE * L_8 = __this->get_profile_12();
			NullCheck(L_8);
			bool L_9;
			L_9 = LostTrackingServiceProfile_get_HaltTimeWhileTrackingLost_m5D333A5647865ACB2B1EA79B7EE2B4F1ADE18CA8_inline(L_8, /*hidden argument*/NULL);
			V_3 = L_9;
			bool L_10 = V_3;
			if (!L_10)
			{
...
IL_0059:
		{
			...
			LostTrackingServiceProfile_tB5E9DC2D6BDBB0A0F4E8EF30D8C59FB4D6B84CFE * L_12 = __this->get_profile_12();
			NullCheck(L_12);
			bool L_13;
			L_13 = LostTrackingServiceProfile_get_HaltAudioOnTrackingLost_m39459377E2A7013B1D7ED62846D937C700B46DBC_inline(L_12, /*hidden argument*/NULL);
			V_4 = L_13;
			bool L_14 = V_4;
			if (!L_14)
			{
...
IL_0073:
		{
			...
			NullCheck(L_15);
			InterfaceActionInvoker1< bool >::Invoke(1 /* System.Void Microsoft.MixedReality.Toolkit.Extensions.Tracking.ILostTrackingVisual::set_Enabled(System.Boolean) */, ILostTrackingVisual_tF2454A398CC66BF968E6CFDA1079540F168C5DBB_il2cpp_TypeInfo_var, L_15, (bool)0);
		}
...
IL_001d:
		{
			...
			LostTrackingServiceProfile_tB5E9DC2D6BDBB0A0F4E8EF30D8C59FB4D6B84CFE * L_4 = __this->get_profile_12();
			NullCheck(L_4);
			GameObject_tC000A2E1A7CF1E10FD7BA08863287C072207C319 * L_5;
			L_5 = LostTrackingServiceProfile_get_TrackingLostVisualPrefab_m8AE4BFB2D9166267E89E662EF802B09A4FCFF91D_inline(L_4, /*hidden argument*/NULL);
			IL2CPP_RUNTIME_CLASS_INIT(Object_tF2F3778131EFF286AF62B7B013A170F95A91571A_il2cpp_TypeInfo_var);
...
IL_003c:
		{
			...
			NullCheck(L_10);
			RuntimeObject* L_11;
			L_11 = GameObject_GetComponentInChildren_TisILostTrackingVisual_tF2454A398CC66BF968E6CFDA1079540F168C5DBB_mC58D89B45162CB184538C25AE9CF148467DB27B1(L_10, /*hidden argument*/GameObject_GetComponentInChildren_TisILostTrackingVisual_tF2454A398CC66BF968E6CFDA1079540F168C5DBB_mC58D89B45162CB184538C25AE9CF148467DB27B1_RuntimeMethod_var);
...
IL_006a:
		{
			...
			NullCheck(L_14);
			InterfaceActionInvoker1< bool >::Invoke(1 /* System.Void Microsoft.MixedReality.Toolkit.Extensions.Tracking.ILostTrackingVisual::set_Enabled(System.Boolean) */, ILostTrackingVisual_tF2454A398CC66BF968E6CFDA1079540F168C5DBB_il2cpp_TypeInfo_var, L_14, (bool)0);
		}
...
IL_0078:
		{
			...
			NullCheck(L_15);
			bool L_16;
			L_16 = InterfaceFuncInvoker0< bool >::Invoke(0 /* System.Boolean Microsoft.MixedReality.Toolkit.Extensions.Tracking.ILostTrackingVisual::get_Enabled() */, ILostTrackingVisual_tF2454A398CC66BF968E6CFDA1079540F168C5DBB_il2cpp_TypeInfo_var, L_15);
...
IL_008f:
		{
			...
			LostTrackingServiceProfile_tB5E9DC2D6BDBB0A0F4E8EF30D8C59FB4D6B84CFE * L_22 = __this->get_profile_12();
			NullCheck(L_22);
			LayerMask_t5FA647D8C300EA0621360CA4424717C3C73190A8  L_23;
			L_23 = LostTrackingServiceProfile_get_TrackingLostCullingMask_m1FFC49355D348984331C8B7D95C1A7AE0363924D_inline(L_22, /*hidden argument*/NULL);
			int32_t L_24;
			...
			// if (profile.HaltTimeWhileTrackingLost)
			LostTrackingServiceProfile_tB5E9DC2D6BDBB0A0F4E8EF30D8C59FB4D6B84CFE * L_25 = __this->get_profile_12();
			NullCheck(L_25);
			bool L_26;
			L_26 = LostTrackingServiceProfile_get_HaltTimeWhileTrackingLost_m5D333A5647865ACB2B1EA79B7EE2B4F1ADE18CA8_inline(L_25, /*hidden argument*/NULL);
			V_7 = L_26;
			bool L_27 = V_7;
			if (!L_27)
			{
...
IL_00e4:
		{
			// if (profile.HaltAudioOnTrackingLost)
			LostTrackingServiceProfile_tB5E9DC2D6BDBB0A0F4E8EF30D8C59FB4D6B84CFE * L_28 = __this->get_profile_12();
			NullCheck(L_28);
			bool L_29;
			L_29 = LostTrackingServiceProfile_get_HaltAudioOnTrackingLost_m39459377E2A7013B1D7ED62846D937C700B46DBC_inline(L_28, /*hidden argument*/NULL);
			V_8 = L_29;
			bool L_30 = V_8;
			if (!L_30)
			{
...
IL_00fe:
		{
			...
			NullCheck(L_31);
			InterfaceActionInvoker1< bool >::Invoke(1 /* System.Void Microsoft.MixedReality.Toolkit.Extensions.Tracking.ILostTrackingVisual::set_Enabled(System.Boolean) */, ILostTrackingVisual_tF2454A398CC66BF968E6CFDA1079540F168C5DBB_il2cpp_TypeInfo_var, L_31, (bool)1);
			// visual.SetLayer(profile.TrackingLostVisualLayer);
			RuntimeObject* L_32 = __this->get_visual_13();
			LostTrackingServiceProfile_tB5E9DC2D6BDBB0A0F4E8EF30D8C59FB4D6B84CFE * L_33 = __this->get_profile_12();
			NullCheck(L_33);
			int32_t L_34;
			L_34 = LostTrackingServiceProfile_get_TrackingLostVisualLayer_m6278076B0A351EB7CA01235A781593BFC9E960FD_inline(L_33, /*hidden argument*/NULL);
			NullCheck(L_32);
			InterfaceActionInvoker1< int32_t >::Invoke(2 /* System.Void Microsoft.MixedReality.Toolkit.Extensions.Tracking.ILostTrackingVisual::SetLayer(System.Int32) */, ILostTrackingVisual_tF2454A398CC66BF968E6CFDA1079540F168C5DBB_il2cpp_TypeInfo_var, L_32, L_34);
			// visual.ResetVisual();
			RuntimeObject* L_35 = __this->get_visual_13();
			NullCheck(L_35);
			InterfaceActionInvoker0::Invoke(3 /* System.Void Microsoft.MixedReality.Toolkit.Extensions.Tracking.ILostTrackingVisual::ResetVisual() */, ILostTrackingVisual_tF2454A398CC66BF968E6CFDA1079540F168C5DBB_il2cpp_TypeInfo_var, L_35);
		}
...
IL_0020:
		{
			...
			LostTrackingService_set_TrackingLost_m56BB1B8E5CA81BC7A7D216C32C19F9595BFDF09B_inline(__this, L_5, /*hidden argument*/NULL);
			// if (TrackingLost)
			bool L_6;
			L_6 = LostTrackingService_get_TrackingLost_m97C5E8928D92794CD4CED1BA8AA9CECA9AB4E309_inline(__this, /*hidden argument*/NULL);
			V_3 = L_6;
			bool L_7 = V_3;
			if (!L_7)
			{
...
IL_0033:
		{
			...
			L_8 = LostTrackingService_get_OnTrackingLost_m13591A64B213208D6F1340736828767FB0A41D14_inline(__this, /*hidden argument*/NULL);
...
IL_0050:
		{
			...
			L_10 = LostTrackingService_get_OnTrackingRestored_m4E2AC05110C7C4E5B44696F4074B5F37079D3A65_inline(__this, /*hidden argument*/NULL);
...
IL_0018:
	...
	}
	{
		...
		List_1_tC3943A359D121C56123E4142DF967EF5FCCAF2C3 * L_5 = ((LostTrackingService_t71DEC83A25AFE6BD285FCDA2504CC7FD0656EB0D_StaticFields*)il2cpp_codegen_static_fields_for(LostTrackingService_t71DEC83A25AFE6BD285FCDA2504CC7FD0656EB0D_il2cpp_TypeInfo_var))->get_XRSessionSubsystems_23();
		NullCheck(L_5);
...
IL_004f:
		{
			...
			IL2CPP_RUNTIME_CLASS_INIT(LostTrackingService_t71DEC83A25AFE6BD285FCDA2504CC7FD0656EB0D_il2cpp_TypeInfo_var);
			((LostTrackingService_t71DEC83A25AFE6BD285FCDA2504CC7FD0656EB0D_StaticFields*)il2cpp_codegen_static_fields_for(LostTrackingService_t71DEC83A25AFE6BD285FCDA2504CC7FD0656EB0D_il2cpp_TypeInfo_var))->set_sessionSubsystem_22(L_11);
			// break;
			goto IL_0062;
		}
...
IL_0074:
	{
		...
		IL2CPP_RUNTIME_CLASS_INIT(LostTrackingService_t71DEC83A25AFE6BD285FCDA2504CC7FD0656EB0D_il2cpp_TypeInfo_var);
		XRSessionSubsystem_t8AD3C01568AA19BF038D23A6031FF9814CAF93CD * L_13 = ((LostTrackingService_t71DEC83A25AFE6BD285FCDA2504CC7FD0656EB0D_StaticFields*)il2cpp_codegen_static_fields_for(LostTrackingService_t71DEC83A25AFE6BD285FCDA2504CC7FD0656EB0D_il2cpp_TypeInfo_var))->get_sessionSubsystem_22();
		V_4 = L_13;
		goto IL_007d;
	}
